-- DROP FUNCTION get_person_id_by_home_phone_id;

-- update with new phone number return true if success, else false
-- CREATE OR REPLACE FUNCTION update_person_home_phone(
--   i_id INT,
...
-- CREATE OR REPLACE FUNCTION delete_person_home_phone(
--   i_id INT
-- )
--   RETURNS BOOLEAN
--   AS $$
--   BEGIN  
--       DELETE FROM person_home_phone AS p
--       WHERE p.id = i_id;
--       RETURN FOUND;
--   END
-- $$ LANGUAGE plpgsql;
...
-- CREATE OR REPLACE FUNCTION get_person_id_by_home_phone_id(
--   i_phone_id INT
-- )
--   RETURNS INT
--   AS $$
...
-- CREATE OR REPLACE FUNCTION get_home_phone_by_person_id(
--   i_person_id INT
-- )
...
-- DROP FUNCTION insert_person_home_phone;

-- On successful insertion return TRUE, else FALSE

-- CREATE OR REPLACE FUNCTION insert_person_home_phone(
--   i_person_id INT,
--   i_phone_id INT
-- )
--   RETURNS BOOLEAN
...
--     INSERT INTO person_home_phone (person_id, phone_id) 
